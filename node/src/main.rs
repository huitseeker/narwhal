...
async fn main() -> Result<()> {
    ...
    let filter = EnvFilter::builder()
        ...
        .parse(format!(
            "{tracing_level},primary::block_waiter=trace,primary::block_synchronizer=trace,h2={network_tracing_level},tower={network_tracing_level},hyper={network_tracing_level},tonic::transport={network_tracing_level},{custom_directive}"
        ))?;
